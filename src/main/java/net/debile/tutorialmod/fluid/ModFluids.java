package net.debile.tutorialmod.fluid;
...
public class ModFluids {
    ...
    //właściwości fizyczne + tekstury
    public static final RegistryObject<FluidType> FUEL_TYPE = FLUID_TYPES.register("fuel",
            () -> new FluidType(FluidType.Properties.create()
                    .density(800)       //woda = 1000; paliwo lżejsze
                    .viscosity(1200)) { //woda = 1000; paliwo nieco gęstsze
    ...
    //Blok w świecie reprezentujący paliwo
    ...
    private static ForgeFlowingFluid.Properties makeProperties() {
        return new ForgeFlowingFluid.Properties(FUEL_TYPE, FUEL_SOURCE, FUEL_FLOWING)
                .slopeFindDistance(4)       //jak daleko się rozlewa (woda = 4)
                .levelDecreasePerBlock(1)   //jak szybko opada poziom (woda = 1)
                .block(FUEL_BLOCK)
                .bucket(FUEL_BUCKET);
    }
